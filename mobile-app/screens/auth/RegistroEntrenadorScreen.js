...
const RegistroEntrenadorScreen = ({ navigation }) => {
  ...
  const handleRegistro = async () => {
    ...
    try {
      ...
      if (res.ok) {
        Alert.alert('Éxito', 'Entrenador registrado correctamente');
  ...
  return (
    <View style={{ flex: 1, backgroundColor: COLORS.background }}>
      ...
      >
        <Text style={styles.title}>Registro de Entrenador</Text>
        ...
        <Card>
          ...
          <TouchableOpacity style={styles.imagePlaceholder} onPress={handlePickImage}>
            {foto ? (
              ...
              <Text style={styles.placeholderText}>[Foto de Identificación / Credencial]</Text>
            )}
          </TouchableOpacity>
...
export default RegistroEntrenadorScreen;
